...
# class CNNwithSEBlock_5(nn.Module):
#     def __init__(self):
#         super(CNNwithSEBlock_5,self).__init__()
...
# class CNNwithSelfattention_5(nn.Module):
#     def __init__(self):
#         super(CNNwithSelfattention_5,self).__init__()
...
# class CNN3D_5(nn.Module):
#     def __init__(self):
#         super(CNN3D_5,self).__init__()
